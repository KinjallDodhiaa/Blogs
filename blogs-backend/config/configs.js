...
const connectionString = "mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@clhttps://kinjals-blog.herokuapp.com/postsuster0.kgubn.mongodb.net/blogs?retryWrites=true&w=majority";
const devConfig = {
  db: connectionString,
  jwt_key: "FbW43-2-110%",
};
